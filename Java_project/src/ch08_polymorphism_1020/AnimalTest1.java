...
class Tiger extends Animal{
	...
	public void eat()
	{
		System.out.println("호랑이가 고기를 먹었다.");
	}
	public void sound()
	{
		System.out.println("호랑이가 소리를 낸다.");
	}
}
...
class Eagle extends Animal{
	...
	public void eat()
	{
		System.out.println("독수리가 고기를 먹었다.");
	}
	public void sound()
	{
		System.out.println("독수리가 소리를 낸다.");
	}
}
...
class Lsy extends Animal{
	...
	public void eat()
	{
		System.out.println("상용이가 고기를 먹었다.");
	}
	public void sound()
	{
		System.out.println("이상용이 소리를 낸다.");
	}
}
...
class Monkey extends Animal{
	public void move()
	{
		System.out.println("원숭이가 두 발로 걷습니다. ");
	}
	
	public void eat()
	{
		System.out.println("원숭이가 과일을 먹는다. ");
	}
	public void sound()
	{
		System.out.println("원숭이가 끼끼 소리를 낸다.");
	}
}
...
public class AnimalTest1 {
	...
	// 해당 기능을 각 자식 클래스에서 다르게 구현을 유연하게 하기 위해서 -> 인터페이스, 추상클래스. 
	 ...
	 public static void main(String[] args) {
		  ...
		  //Human h1 = new Human();
		  //aTest. moveanimal(h1); == 이 두줄이 밑에 한줄과 같은 뜻
		  aTest.moveAnimal(new Human());
		  aTest.moveAnimal(new Tiger());
		  aTest.moveAnimal(new Eagle());
		  aTest.moveAnimal(new Monkey());
//		  aTest.moveAnimal(new Lsy()); = 밑에 두줄과 같음
		  Lsy lsy = new Lsy();
