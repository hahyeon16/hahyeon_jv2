...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		Student studentJung = new Student(1050, "Jung"); 
		// 본인 수강하고 싶은 과목 3개를 등록하기(점수 포함). 예) java, spring, Android

		studentJung.addSubject("java", 100);
		studentJung.addSubject("spring", 100);
		studentJung.addSubject("Android", 100);
		...
		studentJung.addMenu("스테이크",8900,"자라 건물에 5층인데 만화카페 옆 로봇이 배달해줌. 먹을만함");
